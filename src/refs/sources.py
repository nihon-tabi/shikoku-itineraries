...
SOURCES.update({
 ...
 "konpira_opendays": ("Konpira-san — museum opening days REVISED from 1 April 2026, shrine notice",
                      "https://www.konpira.or.jp/", "operator"),
 "yashima_aq_closed": ("Shin-Yashima Aquarium — closed for rebuilding, operating off-site as Ichiba Aquarium until spring 2027",
                       "https://r.goope.jp/new-yashima-aq/", "operator"),
